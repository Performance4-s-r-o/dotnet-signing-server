...
namespace dotnetsigningserver.Migrations
{
    ...
    [Migration("20260825081510_AddPasswordIterationsAndTokenHashing")]
    partial class AddPasswordIterationsAndTokenHashing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DotNetSigningServer.Models.User", b =>
                {
                    ...
                    b.Property<int?>("ConcurrencyQueueTimeoutSeconds")
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTimeOffset?>("EnterpriseEnabledAt")
                        .HasColumnType("timestamp with time zone");
